...
```{r echo=FALSE}
source("src/DataModel.R")             #functions used to map the raw data for use in analyses
source("src/ExperimentalPlots.R")     #functions to plot the data
source("src/mapIBVdata.R")            #Map the data of this IBR experimetn
source("src/FinalSizeFastImplementation.R") #Functions to do the final size calculations
```
